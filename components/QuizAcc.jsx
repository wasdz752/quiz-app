    ...
    return (
        <div className="question-container d-flex-col">
            ...
            <div className="question-inner d-flex-row flex-grow">
                ...
                <OptionsList question={htmlQuiz.questions[questionCount] ?? null} nextQuestion={setQuestionCount} questionCount={questionCount} icon={"accessibility"}/>
            </div>
